...
function setup() {
  ...
  bkground2=createSprite(width/2+3000,height/2,20,20);
...
// gianlev2Group.add(gianlev2);
 ...
 treasure=createSprite(width/2+700,height/2-300,20,20);
...
if(wall13.y<height/2-375)
{
wall13.velocityY=4
}

if(wall14.y<height/2-297)
{
wall14.velocityY=4
}

if(wall15.y<height/2-221)
{
wall15.velocityY=4
}

if(wall16.y<height/2-145)
{
wall16.velocityY=4
}
